...
Router::connect('/flickr/photo/{:farm}/{:server}/{:id}_{:secret}.{:type}', 'Static::flickr');

Router::connect('/static/{:cache_id:[0-9]{6}}/{:path:.*}.{:type}', 'Static::file');
