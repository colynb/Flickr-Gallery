 ...
 */
Media::type('css', 'text/css', array('cast' => false, 'encode' => function($s) { return $s; }));
Media::type('js', array('application/javascript', 'text/javascript'), array('cast' => false, 'encode' => function($s) { return $s; }));
Media::type('gif', 'image/gif', array('cast' => false, 'encode' => function($s) { return $s; }));
Media::type('jpg', 'image/jpeg', array('cast' => false, 'encode' => function($s) { return $s; }));
Media::type('png', 'image/png', array('cast' => false, 'encode' => function($s) { return $s; }));
