 ...
 */
define('LITHIUM_LIBRARY_PATH', dirname('/var/www/html/lithium-apps/lib/lithium'));
...
Libraries::add('Flickr');
Libraries::add('Imagine');
//$flickr = Libraries::get('Imagine');
/**
...
$content = file_get_contents('http://farm8.staticflickr.com/7012/6818065785_a294ab34db.jpg');
file_put_contents('test.jpg',$content);

$mode = Imagine\Image\ImageInterface::THUMBNAIL_OUTBOUND;
$imagine->open('test.jpg')
->thumbnail($size, $mode)
->save('thumbnail.png');
**/
?>